...
# Mock模块导入处理
try:
    from test_manage_mcp.test_manage_mcp import TestManageMcp
    MOCK_MODE = False
    print("成功导入真实模块")
...
class TestTestManageMcpComprehensive(IsolatedAsyncioTestCase):
    """
    TestManageMcp 完整测试套件
    """
    ...
    def setUp(self):
        ...
        # 创建测试实例
        try:
            self.test_instance = TestManageMcp()
