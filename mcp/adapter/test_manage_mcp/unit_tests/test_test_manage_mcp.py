...
class TestTestManageMcp(unittest.IsolatedAsyncioTestCase):
    """
    test_manage_mcp 单元测试类
...
def run_tests():
    ...
    # 运行测试套件
    suite = unittest.TestLoader().loadTestsFromTestCase(TestTestManageMcp)
